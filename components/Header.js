  ...
  <div className="sticky top-0 p-5 z-50 bg-black rounded-md shadow-sm shadow-[#fb03ff] border-b-2 border-[#fb03ff] text-[#fb03ff]">
      <div className="grid grid-cols-5 lg:grid-cols-6 items-end lg:items-center">
          <div className="text-left lg:text-center col-span-6">
              <div className="relative h-48 w-48 lg:mx-auto border-[#fb03ff] border-8 rounded-full inline-grid">
                  <Avatar changeAvatar />
              </div>
              <h2 className="text-3xl mt-4 ml-10 lg:ml-0  font-bold truncate">{user.getUsername()}</h2>
